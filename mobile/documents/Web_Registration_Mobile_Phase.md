...
### Domain Layer
- [x] Create `member_login_response.dart` with freezed
- [x] Update `auth_state.dart` - add mustChangePassword, pendingPinSetup states
- [x] Update `auth_tokens.dart` - add `fromMemberLoginResponse` factory method
- [x] Run `dart run build_runner build` to generate code
- [x] Write unit tests for domain models (35 tests passing)

### Data Layer
- [x] Update `auth_api.dart` - add loginWithEmail, changePassword methods
- [x] Update `auth_repository.dart` - add loginWithEmail, changePassword, getMe methods
- [x] Update `secure_storage.dart` - add email and PIN storage methods

### Provider Layer
- [x] Update `auth_providers.dart` - implement new login flow
- [x] Run `dart run build_runner build`
- [x] Write unit tests for AuthNotifier (26 tests passing)

### Presentation Layer
- [x] Create `email_input_field.dart`
- [x] Create `password_input_field.dart`
- [x] Create `email_login_page.dart`
- [x] Create `change_password_page.dart`
- [x] Create `pin_setup_email_page.dart` - simplified for post-password flow
- [x] Write widget tests (28 tests: EmailLoginPage 8, ChangePasswordPage 11, PinSetupEmailPage 9)

### Navigation
- [x] Update `app_router.dart` - new routes and redirects
- [x] Run `dart run build_runner build`

### Localization
- [x] Add new strings to `app_en.arb` (all 30+ strings from Section 7)
- [x] Run `flutter gen-l10n` (verified: app_localizations.dart and app_localizations_en.dart generated)
- [x] Verify pages use localized strings via `S.of(context)` (EmailLoginPage, ChangePasswordPage, PinSetupEmailPage)

### Cleanup
- [x] Delete `phone_entry_page.dart`
- [x] Delete `otp_verify_page.dart`
- [x] Delete `registration_page.dart`
- [x] Delete `login_page.dart` (old OTP-based)
- [x] Delete `pin_setup_page.dart` (old OTP-based)
- [x] Delete `otp_input_field.dart`
- [x] Delete `phone_input_field.dart`
- [x] Delete `otp_request.dart`
- [x] Delete `otp_verify_result.dart`
- [x] Delete `check_phone_response.dart`
- [x] Delete `registration_request.dart`
- [x] Delete `backend_registration_request.dart`
- [x] Delete `login_request.dart` (moved types to `auth_types.dart`)
- [x] Create `auth_types.dart` with shared types (AuthTokens, MemberProfile, etc.)
- [x] Delete related tests (10 test files)
- [x] Update barrel files (pages.dart, widgets.dart)
- [x] Update auth_api.dart - remove OTP methods
- [x] Update auth_repository.dart - remove OTP methods
- [x] Update auth_providers.dart - remove OTP methods

### Testing
- [x] Run all existing tests - fix any failures (261 tests passing)
- [x] Write tests for new components (widget tests for 3 new pages)
