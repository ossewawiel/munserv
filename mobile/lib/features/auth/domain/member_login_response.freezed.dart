...
bool operator ==(Object other) {
  final _this = this as MemberLoginResponse;
...
int get hashCode {
  final _this = this as MemberLoginResponse;
  return Object.hash(runtimeType,_this.memberId,_this.accessToken,_this.refreshToken,_this.expiresIn,_this.mustChangePassword);
}

@override
String toString() {
  final _this = this as MemberLoginResponse;
  return 'MemberLoginResponse(memberId: ${_this.memberId}, accessToken: ${_this.accessToken}, refreshToken: ${_this.refreshToken}, expiresIn: ${_this.expiresIn}, mustChangePassword: ${_this.mustChangePassword})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? memberId = null,Object? accessToken = null,Object? refreshToken = null,Object? expiresIn = null,Object? mustChangePassword = null,}) {
  return _then(MemberLoginResponse(
...
@override
int get hashCode {
    return Object.hash(runtimeType,memberId,accessToken,refreshToken,expiresIn,mustChangePassword);
}
