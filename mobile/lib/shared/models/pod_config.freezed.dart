...
class _PodConfig extends PodConfig {
  const _PodConfig({required this.podId, required this.podName, required this.primaryColor, required this.secondaryColor, this.tertiaryColor, this.logoUrl, this.fontFamily, final  List<String> supportedLocales = const ['en'], this.defaultLocale = 'en'}): _supportedLocales = supportedLocales,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PodConfig&&(identical(other.podId, podId) || other.podId == podId)&&(identical(other.podName, podName) || other.podName == podName)&&(identical(other.primaryColor, primaryColor) || other.primaryColor == primaryColor)&&(identical(other.secondaryColor, secondaryColor) || other.secondaryColor == secondaryColor)&&(identical(other.tertiaryColor, tertiaryColor) || other.tertiaryColor == tertiaryColor)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl)&&(identical(other.fontFamily, fontFamily) || other.fontFamily == fontFamily)&&const DeepCollectionEquality().equals(other._supportedLocales, _supportedLocales)&&(identical(other.defaultLocale, defaultLocale) || other.defaultLocale == defaultLocale));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,podId,podName,primaryColor,secondaryColor,tertiaryColor,logoUrl,fontFamily,const DeepCollectionEquality().hash(_supportedLocales),defaultLocale);
