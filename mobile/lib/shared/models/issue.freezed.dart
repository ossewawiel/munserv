...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,state,location,address,description,heat,const DeepCollectionEquality().hash(photoUrls),sectorId,reporterId,reportCount,createdAt,updatedAt);
...
class _Issue extends Issue {
  const _Issue({required this.id, required this.type, required this.state, required this.location, this.address, this.description, required this.heat, required final  List<String> photoUrls, required this.sectorId, required this.reporterId, required this.reportCount, required this.createdAt, required this.updatedAt}): _photoUrls = photoUrls,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,state,location,address,description,heat,const DeepCollectionEquality().hash(_photoUrls),sectorId,reporterId,reportCount,createdAt,updatedAt);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,state,location,heat,thumbnailUrl,createdAt);
