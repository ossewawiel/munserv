...
### API & Hooks
- [ ] Update `auth/api.ts` - add registerMember
- [ ] Update `members/api.ts` - add approve, reject, getPendingCount
- [ ] Update `auth/hooks.ts` - add useRegisterMember, useSectors
- [ ] Update `members/hooks.ts` - add useApproveMember, useRejectMember, usePendingMemberCount

### Types
- [ ] Update `auth/types.ts` - add RegisterRequest, RegisterResponse
...
### Testing
- [ ] Write tests for RegisterPage
- [ ] Write tests for RegisterForm
