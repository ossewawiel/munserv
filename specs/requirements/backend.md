...
| B6 | As a developer, the system checks bootstrap eligibility | Query: Pod Chief exists AND is onboarded? ǀ Returns bootstrap status ǀ No new DB table needed | 🔴 Pending | [#47](https://github.com/ossewawiel/munserv/issues/47) |
