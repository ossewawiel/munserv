...
|----|-------|---------------------|--------|-------|
| M1 | Login with email/password | Enter email + password → if first login: change password → setup PIN → access app | 🟢 Done | [#3](https://github.com/ossewawiel/munserv/issues/3) |
