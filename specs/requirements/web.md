...
| W18 | As a Pod Chief, I can configure the pod name and logo | Set pod name ǀ Name appears in header as "Munserv Pod [name]" ǀ Upload logo ǀ Munserv icon shows in orange on background | 🟢 Done | [#29](https://github.com/ossewawiel/munserv/issues/29) |
| W18b | As a Pod Chief, I can upload a pod logo from Pod Settings | File picker in Pod Settings ǀ Upload saves the returned `logoUrl` to the pod settings ǀ Logo appears in the identity card and header without reload ǀ Invalid type or oversize file rejected inline ǀ Control disabled while uploading | 🔴 Pending | [#97](https://github.com/ossewawiel/munserv/issues/97) |
...
| W29 | As a super user, I can use temporary access for debugging | Login with temp grant ǀ Role-limited access ǀ Session shows expiry timer ǀ Auto-logout on expiry ǀ All actions audit logged | 🟢 Done | [#44](https://github.com/ossewawiel/munserv/issues/44) |
